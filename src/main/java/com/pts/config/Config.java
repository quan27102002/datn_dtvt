...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:80/return";
    public static String vnp_TmnCode = "X91BFMW7";
    public static String vnp_HashSecret = "MVRCJCJQFQRDAKVGPPIGABDUJHXLSNQS";
